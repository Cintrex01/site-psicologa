      ...
      <div className={styles.aboutMeText}>
        ...
        <div>
          ...
          <p>
            ...
            única e, por isso, minha prática é pautada na escuta cuidadosa e na
            leitura sensível das necessidades de quem se senta à minha frente.
          </p>
          <p>
          ...
          <p>
            Meu propósito na clínica não é apenas tratar sintomas, mas caminhar
            junto com você, oferecendo suporte para lidar com os desafios da
            vida de forma mais flexível, fluida e leve. No espaço terapêutico,
            procuro cultivar um ambiente seguro, amoroso e gentil, onde o
            cuidado seja sempre integrativo.
          </p>
          <p>
            Neste site, você conhecerá um pouco mais sobre mim e os serviços que
            ofereço.
          </p>
